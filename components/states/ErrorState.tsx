  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onRetry}
        className="mt-6 inline-flex h-10 items-center rounded-lg bg-fg px-4 text-sm font-semibold text-bg transition-colors hover:bg-accent hover:text-accent-fg"
      >
        Retry
      </button>
    </div>
